...
export function ExplorerBody(model: RecordsPageModel) {
  ...
  const rowShape = (record: RecordSummary | null | undefined): { canEdit: boolean; canSupersede: boolean; lifecycle: string; locked: boolean } | null => {
    if (!record) return null
    return { canEdit: record.capabilities.edit, canSupersede: record.capabilities.supersede, lifecycle: record.lifecycle, locked: record.locked }
  }
