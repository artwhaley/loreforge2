...
export const Domains: CollectionConfig = {
  ...
  fields: [
    ...
    { name: 'headingFontKey', type: 'select', label: 'Heading font', options: [{ label: 'Georgia (traditional serif)', value: 'georgia' }, { label: 'Palatino (bookish serif)', value: 'palatino' }, { label: 'Newsreader (Loreforge editorial serif)', value: 'newsreader' }, { label: 'Verdana (neutral sans-serif)', value: 'verdana' }, { label: 'Trebuchet (friendly sans-serif)', value: 'trebuchet' }, { label: 'Lato (Loreforge clean sans)', value: 'lato' }], defaultValue: 'georgia', required: true },
    { name: 'bodyFontKey', type: 'select', label: 'Body font', options: [{ label: 'Verdana (highly readable sans)', value: 'verdana' }, { label: 'Georgia (readable serif)', value: 'georgia' }, { label: 'Trebuchet (friendly sans)', value: 'trebuchet' }, { label: 'Tahoma (compact sans)', value: 'tahoma' }, { label: 'Lato (Loreforge clean sans)', value: 'lato' }, { label: 'Newsreader (editorial serif)', value: 'newsreader' }], defaultValue: 'verdana', required: true },
    ...
    { name: 'designTemplate', type: 'select', label: 'Design template', options: [{ label: 'Civic (classic community)', value: 'civic' }, { label: 'Ledger (Loreforge print)', value: 'ledger' }, { label: 'Poster (bold modern)', value: 'poster' }], defaultValue: 'civic' },
