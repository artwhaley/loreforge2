...
export const Templates: CollectionConfig = {
  ...
  fields: [
    ...
    { name: 'destinationFolder', type: 'relationship', relationTo: 'folders', required: true, label: 'Legacy destination Folder', admin: { hidden: true, readOnly: true, description: 'Retained for migration compatibility. New records route from their Document Type.' } },
    { name: 'allowDestinationOverride', type: 'checkbox', defaultValue: false, admin: { hidden: true, readOnly: true, description: 'Deprecated compatibility flag; customer creation cannot override a Document Type route.' } },
