 ...
 * (or a Type's inspector) with the owning Type in the URL. The Type carries
 * placement and permissions, so it is fixed context here — not a choice.
 */
export default async function NewDocumentTemplatePage({ params, searchParams }: Props) {
