...
export function RecordsExplorer({ base, tenantSlug, folders, records, totalRecordCount, documentTypes, supersessionEdges, initialFolderId, initialSearch, canManageFolders, canActOnRecords, canDeleteRecords }: Props) {
