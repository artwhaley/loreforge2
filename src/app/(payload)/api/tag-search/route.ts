...
export async function GET(request: Request) {
  ...
  // P08-GATE-04: legacy domain-admins rows are never authority. Admission is
  // acting-identity membership (or the matching domain_admin via the decision
  // engine); owner navigation alone does not authorize search.
