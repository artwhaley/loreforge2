  ...
  return (
    <div className={styles.root} style={cssVars as React.CSSProperties}>
      ...
      <header className={styles.header}>
        ...
        {role === 'admin' ? <nav className={styles.managementNav} aria-label={`${tenant.name} administration`}><Link href={`${base}/manage/people`}>People</Link><Link href={`${base}/roles`}>Roles</Link><Link href={`${base}/forms`}>Templates &amp; Forms</Link><Link href={`${base}/customize`}>Customize</Link></nav> : null}
