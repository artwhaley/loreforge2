...
export function PlatformShell({ children }: { children: ReactNode }) {
  return (
    <div className={styles.page}>
      ...
      <footer className={styles.footer}><div className={styles.footerInner}><Link href="/" className={styles.footerBrand}><span className={styles.mark} aria-hidden="true"><span>LF</span></span><span className={styles.wordmark}>Loreforge</span></Link><p className={styles.footerNote}>A crafted archive for worlds worth remembering.</p><nav aria-label="Footer navigation"><Link href="/about">About Loreforge</Link></nav></div></footer>
    </div>
  )
}
