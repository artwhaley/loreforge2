 ...
 * Authorized server projection of the `/members` route: one row per Domain
 * member Character with its derived Department participation and Role names,
 * plus admin-only server-filtered search results for adding members.
...
export type MemberRow = {
  ...
  controllingUserName: string | null
