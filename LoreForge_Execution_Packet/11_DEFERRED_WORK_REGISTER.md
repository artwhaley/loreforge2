...
| DEF-TAGS-01 | Tag picker on document entry (autocomplete + create-new, required by P05-T01) | Closed by P06-T04: document creation now has a searchable existing-tag/create-new chip picker, with normalized vocabulary merge on the server | P06-T04 creation surface | P06-GATE | CLOSED |
| DEF-PREP-01 | UI to add additional Prepared-by credits beyond the acting Character | Closed by P06-T04: creation has an additional-credit search control; the acting Character remains visible and non-removable | P06-T04 creation surface, GS-17 | P06-GATE | CLOSED |
| DEF-ATTACH-01 | Member tag/concern attach on creation: non-admin Concerns rejected, member tags silently dropped | Closed by P06/P07: Concerns use Document edit authority, creation metadata is transactional and visible, and failed attachment/creation preserves the submitted snapshot | P06-T04; P07-T02 evaluator seam | P06-GATE | CLOSED |
