...
4. Implement the complete Phase-7 capability vocabulary from the Architecture Contract: `read, create_document, edit_document, submit_document, file_document, approve_document, lock_document, unlock_document, delete_document, restore_document, move_document, copy_document, share_document, export_document, manage_folders, manage_templates, manage_types_tags, manage_access, manage_members, manage_claims, manage_roles, assign_roles, assign_subordinates, manage_subdomain, manage_domain_appearance, manage_notices`. Later phases may add new named capabilities such as correspondence moderation without changing evaluator semantics.
